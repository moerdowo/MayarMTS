...
// gradient). Vendored from dither-kit (https://tripwire.sh/dither-kit,
// registry item "gradient") — unmodified. Deliberately free of the chart
// engine so it installs without `core`; only palette.ts is shared.
